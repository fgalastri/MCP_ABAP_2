    ...
    tools: [
      {
        ...
        description: '🔄 Switch between SAP systems (DEV/QA/BTP) without restarting Cursor. All subsequent tool calls will use the selected system.',
        inputSchema: {
          type: 'object',
          properties: {
            system: {
      ...
      {
        name: 'adt_save_domain',
        description: 'Save/Update a Domain with complete XML structure including data type, length, decimals, and fixed values. Automatically handles lock → save → unlock workflow.',
        inputSchema: {
          type: 'object',
          properties: {
            domain_xml: {
      ...
      {
        name: 'adt_save_data_element',
        description: 'Save/Update a Data Element with complete XML structure including domain reference and field labels. Automatically handles lock → save → unlock workflow.',
        inputSchema: {
          type: 'object',
          properties: {
            data_element_xml: {
      ...
      },
      {
        ...
        description: 'Save/Update a Table Type with complete XML structure including row type, access type, and key definitions. Automatically handles lock → save → unlock workflow.',
        inputSchema: {
          type: 'object',
          properties: {
            table_type_xml: {
      ...
      {
        name: 'adt_list_package_objects',
        description: 'List all objects in a package or filter by object type (DTEL, CLAS, DOMA, TABL, etc.). Returns object names, types, descriptions, and URIs.',
        inputSchema: {
          type: 'object',
          properties: {
            package_name: {
